...
EDITOR_PATCH_INSTRUCTIONS = (
    ...
    "- `*...*` marks a span of italic narration that often wraps several sentences. When fixing one sentence inside such a span, match on the prose only — do NOT add asterisks around your `search` or `replace`.\n"
